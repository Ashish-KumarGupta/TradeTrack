    ...
    return ( 
        ...
        <div className='container border-top mt-5'>
            <div className='row mt-5'>
                <div className='col'>
                    <img src='media/download.svg' style={{width:"50%"}} alt='Logo'/>
      ...
      <a href="#" style={{ textDecoration: "none", color: "inherit" }}>NSE</a>
      <a href="#" style={{ textDecoration: "none", color: "inherit" }}>BSE</a>
      <a href="#" style={{ textDecoration: "none", color: "inherit" }}>MCX</a>
      <a href="#" style={{ textDecoration: "none", color: "inherit" }}>Terms & conditions</a>
      <a href="#" style={{ textDecoration: "none", color: "inherit" }}>Policies & procedures</a>
      <a href="#" style={{ textDecoration: "none", color: "inherit" }}>Privacy policy</a>
      <a href="#" style={{ textDecoration: "none", color: "inherit" }}>Disclosure</a>
      <a href="#" style={{ textDecoration: "none", color: "inherit" }}>For investor's attention</a>
      <a href="#" style={{ textDecoration: "none", color: "inherit" }}>Investor charter</a>
    </div>
        </div>
        </footer>
    );
